 ...
 *
 * @param[in] data_type
 * @return Returns a vector that must be freed. NULL is returned if the data type
...
/**
 * Appends a "smallint" to a vector.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
...
/**
 * Appends a "bigint" or "counter" to a vector.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
...
/**
 * Appends a "ascii", "text" or "varchar" to a vector.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
 *
 * @param[in] vector
 * @param[in] value The value is copied into the vector object; the memory pointed to by this
...
/**
 * Same as cass_vector_append_string(), but with lengths for string parameters.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
...
/**
 * Appends a "uuid" or "timeuuid" to a vector.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
...
/**
 * Appends a "duration" to a vector.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
...
/**
 * Appends a "list", "map" or "set" to a vector.
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
...
/**
 * Appends a "vector" to a vector (nested vectors).
 *
 * @cassandra{5.0+}
 *
 * @public @memberof CassVector
